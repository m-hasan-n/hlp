...
function HLP_Testing_Reduced(shared_params , experiment_protocol)

%directory of trials extracted data
trained_models_dir = shared_params.trained_models_dir;
extracted_data_dir = shared_params.extacted_data_dir;
...
for ind_subj_size = 1 : num_size_iter
    ...
    for ind = 1 : num_train_combinations
        ...
        for ii = 1 : length(test_sub_ids)
            ...
            subject_name = sprintf('%03d',test_sub);
...
%                         10*hand_joint,key_config_data(1,:),'blue');
                    ...
                    [best_start_keypoints, best_end_keypoints,best_start_config,...
                        ...
                        row_based_planner_path(row_gap_ids, row_obj_ids,...
                        ...
                        target_obj.width, starting_arm_joints,hand_width,scan_resolution);
